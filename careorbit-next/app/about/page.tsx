  ...
  return (
    <div style={{ fontFamily: "Inter,sans-serif", background: "#FAF8F4" }}>
      ...
      >
        ...
        >
          CareOrbit is a Digital Patient Engagement Platform designed to support
          any patient care journey through education, understanding, motivation,
          and insight-driven improvement. We are a Total Orbit company, built in
          St. Louis, shaped by more than a decade of work alongside Washington
          University, Siteman Cancer Center, and BJC HealthCare.
        </p>
      </div>
      ...
      <div style={{ ...WRAP, padding: "0 28px 96px" }}>
        ...
        >
          ...
          <p style={LEDE}>
            Lean, senior, and hands-on with every client. The people you meet on
            the first call are the people who build your orbit.
          </p>
        </Reveal>
        <div
          style={{
      ...
      <div style={{ ...WRAP, padding: "0 28px 96px" }}>
        ...
        >
          ...
          <p style={LEDE}>
            We have been at this for more than ten years, and we still run lean
            by choice. No layers between you and the people doing the work: the
            team that scopes your orbit builds it, launches it, and sits in your
            quarterly reviews.
          </p>
        </Reveal>
        <Reveal
