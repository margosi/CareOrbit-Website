    ...
    <div style={{ fontFamily: "Inter,sans-serif", background: "#FAF8F4" }}>
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          >
            High-risk industries have spent decades engineering physical safety.
            Behavioral risk has not had the same infrastructure. CareOrbit
            delivers a private, mobile orbit to every worker: what to watch for,
            where to get help, and a way to reach it without going through a
            supervisor.
          </p>
