      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          >
            ...
            program&apos;s requirements, carried from the first seminar through
            long-term follow-up, so every candidate arrives ready and stays on
            plan.
          </p>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              ...
              words, delivered when each instruction actually matters. Alongside
              the seminar and the follow-up visit, an orbit adds a
      ...
      <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 88px" }}>
        ...
        >
          <div data-hdr="" data-grid="split" style={HDR}>
            ...
            >
              A bariatric program is a long qualification process followed by a
              lifetime of behavior change. Both happen mostly at home. The
              operation itself is the shortest part of the journey and the only
              part you fully control. That is the understanding gap, and the
              figures below are what it costs.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              whether a patient met the pre-op requirements, kept up the protein
              and hydration, and came back for follow-up.
            </div>
          </div>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 13 }}>
            ...
            >
              ...
              orbit against usual care across the same shape of pathway a
              bariatric episode follows: requirements and prep, the operation,
              discharge instructions, and the calls in between. The mechanism is
              comprehension. Applying these percentages to a bariatric
              population is a modeled transfer, not a measured bariatric result.
            </div>
            <Link
