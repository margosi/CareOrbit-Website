    ...
    <div style={{ fontFamily: "Inter,sans-serif", background: "#FAF8F4" }}>
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          >
            ...
            assessment, so every participant knows what the study asks and when
            it asks it.
          </p>
      ...
      <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 40px" }}>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <h2 style={{ ...H2_LIGHT, maxWidth: 520 }}>
              A trusted guide your participants keep, from first contact through{" "}
              <Em>close-out</Em>.
            </h2>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              Your consent language and your visit schedule, delivered when each
              one actually matters. Alongside the packet at enrollment and the
              coordinator&apos;s reminder call, an orbit adds a consumer-grade
              digital mentor: engaging video, email, and text outreach that
              keeps people informed, oriented, and on protocol between visits.
            </p>
            <p
              style={{
                fontSize: 16,
        ...
        >
          ...
          >
            ...
            distribute, third-party assessment instruments; licensing stays with
            the instrument owner and your research agreement.
          </div>
        </Reveal>
      </div>
      ...
      <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 88px" }}>
        ...
        >
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              >
                ...
                whether a participant understood what they agreed to, remembered
                the window, and could still be reached when it opened.
              </div>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <div
              ...
              >
                ...
                engagement, yet current tools fall short of capturing real-world
                experience.
              </div>
              <div
                style={{
          ...
          >
            CareOrbit has no published outcome data in community-based research.
            The orbits on this page are blueprints built on the platform&apos;s
            engagement work in clinical care.
          </div>
        </Reveal>
      </div>
      ...
      <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 96px" }}>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ ...EYEBROW, color: "#B0A99E" }}>Measurable value</div>
            <h2 style={H2_LIGHT}>
              How an orbit <Em>provides value</Em>.
            </h2>
          </div>
          <p style={SECTION_LEAD}>
            Every orbit is built against at least one named study metric and the
            accrual or follow-up it protects, agreed before the build starts.
          </p>
        </Reveal>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            >
              ...
              follow-up windows are costing your study the most, and give you a
