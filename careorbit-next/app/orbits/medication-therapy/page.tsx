      ...
      <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 40px" }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              Built to your regimens and protocols before launch. Nothing added
              to your team&apos;s day.
            </p>
          </div>
        </Reveal>
        ...
        >
          <div data-hdr="" data-grid="split" style={HDR}>
            ...
            >
              ...
              is the understanding gap, and the figures below are what it costs.
            </p>
          </div>
          ...
          >
            ...
            >
              None of this is decided at the counter. Each one turns on whether
              a patient understood what the medication does, handled a side
              effect without stopping, and refilled it on time.
            </div>
          </div>
        ...
        <Reveal data-pad="64" style={NAVY_PANEL}>
          ...
          >
            ...
            >
              ...
              [Placeholder: additional orbits in this library to be supplied by
              the CareOrbit team.]
            </p>
          </Reveal>
      ...
      <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 92px" }}>
        ...
        >
          ...
          <p style={SECTION_LEAD}>
            ...
            not medication therapy. We show it as measured and let you judge the
            transfer.
          </p>
        </Reveal>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 13 }}>
            ...
            >
              ...
              orbit against usual care, including the medication instructions
              patients take home. The mechanism is comprehension, not oncology.
              Applying these percentages to a medication therapy population is a
              modeled transfer, not a measured adherence result.
            </div>
            <Link
