        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <h2 style={{ ...H2_LIGHT, maxWidth: 520 }}>
              A trusted digital guide your patients keep, from diagnosis through{" "}
              <Em>survivorship</Em>.
            </h2>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              ...
              outreach that keeps patients and families informed, reassured, and
              on track between visits.
            </p>
            <p
              style={{
                fontSize: 16,
        ...
        >
          <div data-hdr="" data-grid="split" style={HDR}>
            ...
            >
              ...
              radiation, and surveillance. Those appointments carry the clinical
              decisions. Almost everything that determines whether the treatment
              works plays out in between, at home, where the service line
              currently has almost no presence. That is the understanding gap,
              and the figures below are what it costs.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              whether a patient understood the regimen, recognized a side effect
              early, or had the family member with them who manages the
              medications.
            </div>
          </div>
