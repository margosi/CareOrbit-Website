...
import { BehavioralHealthNumbers } from "@/components/orbits/BehavioralHealthNumbers";
import {
  CatalogGrid,
  Em,
  EYEBROW,
...
import {
  ...
  TRIAL_STATS,
  WINDOW,
} from "@/lib/behavioralHealth";

/* Behavioral Health orbit page. Port of
 * v2-maven/BehavioralHealthPage.dc.html.
 *
...
export const metadata = metadataFor("/orbits/behavioral-health");
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            />
            <span style={{ ...EYEBROW, color: "#8A6516" }}>{NAME}</span>
          </div>
          ...
          >
            Measurement-based care, <Em>without the administrative weight</Em>
          </h1>
          ...
          >
            <Link
              href="/book-a-call?src=behavioral-health"
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <h2 style={{ ...H2_LIGHT, maxWidth: 520 }}>
              A trusted digital guide your patients keep, from intake through{" "}
              <Em>ongoing recovery</Em>.
            </h2>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              Your program in your clinicians&apos; own words, delivered when
              each step actually matters. Alongside the intake packet and the
              follow-up call, an orbit adds a consumer-grade digital mentor:
              engaging video, email, and text outreach that keeps patients
              engaged, reassured, and connected between sessions.
            </p>
            <p
              style={{
                fontSize: 16,
            ...
            >
              Built to your program and your crisis resources before launch.
              Nothing added to your team&apos;s day.
            </p>
          </div>
        </Reveal>
      ...
      <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 88px" }}>
        ...
        >
          <div data-hdr="" data-grid="split" style={HDR}>
            ...
            >
              A weekly session is one hour out of one hundred and sixty-eight.
              Recovery, relapse, medication decisions, and the choice to come
              back next week all happen in the other one hundred and
              sixty-seven, at home, where the program has almost no presence.
              That is the understanding gap, and the figures below are what it
              costs.
            </p>
          </div>
          ...
          >
            ...
            >
              None of this is decided in session. Each one turns on whether a
              patient understood the plan, kept taking the medication,
              recognized a warning sign, or came back next week.
            </div>
          </div>
      ...
      <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 96px" }}>
        <Reveal data-pad="64" style={NAVY_PANEL}>
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <h2 style={{ ...H2_LIGHT, color: "#FFFFFF" }}>
                Behavioral health care journeys{" "}
                <Em color={GOLD} weight={500}>
                  currently supported
                </Em>
                .
            ...
            >
              [Placeholder: behavioral health orbit library to be supplied by
              the CareOrbit team.]
            </p>
          </Reveal>
          ...
          >
            <CatalogGrid items={CATALOG} accent={GOLD} />
          </Reveal>
        </Reveal>
      </div>
      ...
      <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 92px" }}>
        ...
        >
          ...
          <p style={SECTION_LEAD}>
            ...
            not behavioral health. We show it as measured and let you judge the
            transfer.
          </p>
        </Reveal>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 13 }}>
            ...
            >
              A controlled trial in surgical oncology compared an orbit against
              usual care. The mechanism it tested is the one behavioral health
              depends on: whether a person understands their plan and knows how
              to reach help between appointments. Applying these percentages to
              a behavioral health population is a modeled transfer, not a
              measured behavioral health result.
            </div>
            <Link
        ...
        >
          <RowHead
            ...
            sub="From live oncology deployments. Behavioral health orbits are built on the same platform."
          />
          <QuotePair quotes={QUOTES} color="#8A6516" />
        </Reveal>
      </div>

      <BehavioralHealthNumbers />
      ...
      >
        ...
        >
          ...
          <SheetRequestForm
            ...
            focus="inputFocusGold"
            resetOnEdit={false}
            pdf="/sheets/careorbit-behavioral-health-2-page.pdf"
            downloadAs="CareOrbit-Behavioral-Health-Info-Sheet.pdf"
          />
        </Reveal>
      </div>
