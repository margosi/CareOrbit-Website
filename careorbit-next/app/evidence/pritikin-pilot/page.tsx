  ...
  return (
    <div style={{ fontFamily: "Inter,sans-serif", background: "#FAF8F4" }}>
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          >
            ...
            to a cardiac rehab orbit. Of those who activated it, 52% went on to
            start the program. Of those who never activated, 24% did.
          </p>
      ...
      <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 88px" }}>
        <div style={PANEL}>
          ...
          >
            ...
            >
              One number carried the pilot: the gap in rehab start rate between
              patients who activated their orbit and patients who never did.
            </p>
          </Reveal>
      ...
      <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 92px" }}>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ ...EYEBROW, color: "#B0A99E" }}>The two cohorts</div>
            <h2 style={H2_LIGHT}>
      ...
      <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 92px" }}>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ ...EYEBROW, color: "#B0A99E" }}>What we learned</div>
            <h2 style={H2_LIGHT}>
              Obstacles, and <Em>what we changed</Em>
            </h2>
          </div>
          <p style={LEAD}>
            A pilot exists to surface problems before full deployment. These are
            the five that mattered, each with the fix it produced.
          </p>
        </Reveal>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            >
              ...
              cohort detail, the KPI scorecard, and the obstacles as we reported
              them. Or bring your own rehab enrollment numbers and we will walk
              through what an orbit could change.
            </p>
            <div>
              <Link
                href={BOOK_HREF}
