      ...
      >
          ...
          >
            ...
            >
              ...
              >
                ...
                Collection is the hard part: patients are home when the surveys
                come due. That is exactly where Assess lives.
              </p>
            </div>
            <div
              style={{
        ...
        <div data-sec="" style={{ ...SEC, padding: "0 28px" }}>
          ...
          >
            ...
            >
              CPT codes shown as examples. Billing eligibility depends on payer
        ...
        <div data-sec="" style={{ ...SEC, padding: "0 clamp(28px,5vw,108px)" }}>
          <Reveal>
            ...
            >
              ...
              working the result: scores are routed, patients are supported, and
              the next assessment is already scheduled.
            </LedgerHeader>
          </Reveal>
          <div style={{ display: "flex", flexDirection: "column" }}>
            {INSIDE.map((m) => (
        ...
        <div data-sec="" style={{ ...SEC, padding: "0 clamp(28px,5vw,108px)" }}>
          <Reveal>
            ...
            >
              The eScreening approach behind Assess is a proven solution in use
              across VA medical centers nationwide, where screening completion
              is a matter of safety, not paperwork.
            </LedgerHeader>
          </Reveal>
          <Reveal
            data-study=""
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              >
                ...
                rate, clinical processes, speed of connection to care, and time
                to document required suicide risk assessments. By 2022 the
                program had been adopted at 19 VA medical centers with 18 more
                adoptions in progress. These are VA program results, cited as
                evidence for the approach Assess is built on.
              </p>
              <Link
        ...
        <div data-sec="" style={{ ...SEC, padding: "0 clamp(28px,5vw,108px)" }}>
          <Reveal>
            ...
            >
              Assess launches without an interface project, a portal rollout, or
              new work for your staff. 90 days to launch, and the first cohort
              reports capture rates against your baseline inside a quarter.
            </LedgerHeader>
          </Reveal>
          <div style={{ display: "flex", flexDirection: "column" }}>
            {LAUNCH.map((m) => (
        ...
        <div id="cta" data-sec="" style={{ ...SEC, padding: "0 28px 104px" }}>
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              ...
              >
                Bring one screening mandate, one PROMs requirement, or one orbit
                you want to hear back from. We will show you what Assess
