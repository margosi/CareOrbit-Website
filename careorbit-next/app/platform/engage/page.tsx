        ...
        >
          ...
          <div data-sec="" style={{ ...SEC, padding: "0 28px" }}>
            <Reveal data-panel="" style={PANEL}>
              ...
              >
                Between visits is when readmissions, cancellations, no-shows,
                and avoidable calls happen. Engage works exactly those weeks.
              </LedgerHeader>
          ...
          >
            <Reveal>
              ...
              >
                An orbit surrounds the patient with the support, information,
                and direction their journey asks for, at every step.
              </LedgerHeader>
            </Reveal>
            <div style={{ display: "flex", flexDirection: "column" }}>
              {MENTOR.map((m) => (
              ...
              >
                ...
                cancellations, no-shows, call volume. It is designed to move
                those numbers, and then measured against them, so engagement is
                never activity for its own sake.
              </p>
            </div>
          </div>
          ...
          <div data-sec="" style={{ ...SEC, padding: "0 28px" }}>
            <Reveal data-panel="" style={PANEL}>
              ...
              >
                Engage launches without an interface project, a portal rollout,
                or new work for your staff. 90 days to launch, and the first
                cohort reports against your baseline inside a quarter.
              </LedgerHeader>
              <div style={{ display: "flex", flexDirection: "column" }}>
                {LAUNCH.map((m) => (
                  <LedgerRow key={m.kicker} block={m} />
          ...
          >
            <Reveal>
              <LedgerHeader
                ...
                heading={
                  <h2 style={H2}>
                    No app. No login. <em style={SERIF}>No new work</em> for
                    your team.
                  </h2>
                }
              >
