          ...
          <div data-sec="" style={{ ...SEC, padding: "0 28px" }}>
            ...
            >
              ...
              >
                ...
                actions and inactions into an engagement index, aligns it with
                the outcomes you care about, and keeps optimizing each
          ...
          <div data-sec="" style={{ ...SEC, padding: "0 28px" }}>
            ...
            >
              ...
              >
                ...
                >
                  CareOrbit tracks every action and inaction across the system
                  and scores it against a predetermined ideal: the engagement
                  pattern that supports an ideal care journey. The result is an
                  index your teams can read at a glance.
                </p>
              </div>
              <div
                data-prob4=""
          ...
          >
            <Reveal>
              ...
              >
                ...
                systems, life sciences, payers, and other industries that need
                to understand how patients actually navigate care.
              </LedgerHeader>
            </Reveal>
            <div style={{ display: "flex", flexDirection: "column" }}>
              {INSIGHTS.map((br) => (
            ...
            >
              ...
              >
                ...
                data. Your patient-level data stays yours, inside your
                governance, with HIPAA, SOC 2, and HITRUST documentation ready
                for review.
              </div>
            </Reveal>
          </div>
