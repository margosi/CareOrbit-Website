        ...
        >
          ...
          <div data-sec="" style={{ ...SEC, padding: "0 28px" }}>
            ...
            >
              ...
              >
                From binder to delivered, in five steps, with expert guidance
                end to end. Capture is built in starting with your first orbit,
                and its use can grow from there to a department or the full
                system.
              </LedgerHeader>
          ...
          >
            <Reveal>
              ...
              >
                ...
                pairs the platform with CareOrbit&apos;s professional service:
                we guide the work and help facilitate it, so your material
                becomes a working system instead of a project on someone&apos;s
                desk.
              </LedgerHeader>
            </Reveal>
            <Reveal
            ...
            >
              ...
              >
                ...
                >
                  ...
                  versioned, findable, or reachable by the patient who needs it
                  at 9pm on a Sunday.
                </p>
              </div>
              <div
          ...
          >
              ...
              <LedgerHeader
                ...
                heading={
                  <h2 style={H2}>
                    ...
                    <em style={SERIF}>your first orbit</em>.
                  </h2>
                }
              >
                Capture is included with your first orbit, gathering and
                converting the material that journey needs. From there, bring
                one packet, binder, or shared drive at a time; converted content
                is reviewed and approved by your team before it reaches a
                patient.
              </LedgerHeader>
            </Reveal>
            <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              ...
              >
                ...
                extended subscription keeps both the tool and the service
                running beyond the orbits you launch, so quarter after quarter
                more of what your teams rely on becomes organized, deployable,
                trackable, HIPAA compliant material, ready wherever it needs to
                go.
              </div>
            </Reveal>
          </div>
