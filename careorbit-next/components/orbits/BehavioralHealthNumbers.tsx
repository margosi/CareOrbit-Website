...
/* The "By the numbers" section of the Behavioral Health page, plus its ROI
 * calculator and sources disclosure. Port of BehavioralHealthPage.dc.html
 * lines 266-387.
 *
 ...
 */
const GOLD = "#E9C46A";
const BOOK_HREF = "/book-a-call?src=behavioral-health";

export function BehavioralHealthNumbers() {
    ...
    <div style={{ maxWidth: 1220, margin: "0 auto", padding: "0 28px 44px" }}>
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <h2 style={H2_LIGHT}>
            What better engagement is <Em>worth</Em> in a year.
          </h2>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            ...
            here as a modeled transfer to a behavioral health population.
          </div>
          <p
            style={{
              fontSize: 17,
      ...
      >
        <ModeledExposure
          ...
          figures={[
            {
              v: "$350K",
              d: "On 1,200 patients a year, at the rates shown below",
            },
            { v: "382 hrs", d: "Clinical time returned over the same year" },
          ]}
          note="Worked on 1,200 patients a year at a 15% readmission rate, $9,000 per event, four calls per patient at nine minutes each, a $40 loaded hourly staff cost, and a 25% no-show rate at $180 per visit. Substitute your own figures and the totals move accordingly."
          buttonLabel={
      ...
      {calcOpen ? (
        <RoiCalculator
          ...
          blurb="Prefilled with 1,200 patients a year and typical program rates. Replace them with your own; the totals update as you type."
          fields={CALC_FIELDS}
          values={calc}
          onChange={(k, raw) =>
          ...
          onExportCsv={() =>
            exportRoiCsv({
              docTitle: "CareOrbit behavioral health ROI model",
              filename: "careorbit-behavioral-health-roi.csv",
              fields: CALC_FIELDS,
              values: calc,
              results,
              total: groupTotal,
          ...
          onPrint={() =>
            printRoiSheet({
              docTitle: "Behavioral health orbit ROI model",
              scaleLine:
